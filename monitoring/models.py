...
class MonitorSession(models.Model):
    ...
    source_mode = models.CharField(max_length=24, choices=SOURCE_CHOICES, default=SOURCE_PHONE)
    camera_source = models.CharField(max_length=120, blank=True, default="phone-camera")
...
class ViolationAlert(models.Model):
    ...
    source_mode = models.CharField(max_length=24, choices=MonitorSession.SOURCE_CHOICES, default=MonitorSession.SOURCE_PHONE)
